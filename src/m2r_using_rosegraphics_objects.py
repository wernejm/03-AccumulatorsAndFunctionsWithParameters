...
#                attach_to(), clone(), and move_center_to()
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle
#             objects have:
#                Center, fill color, and outline color
#
#     f. What does a RoseWindow RENDER method do?
#            This draws all the created objects on the window -- this is crucial for animation.
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            At the end of a block of *animation* code -- this makes it so that the window doesn't close after rendering
#
